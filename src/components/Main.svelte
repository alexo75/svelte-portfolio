  ...
  >
    ...
    >
      ...
      <p class="text-base sm:text-lg md:text-xl">
        I'm a fledgling full stack developer, learning SvelteKit with experience in
        a wide variety of languages. I'm currently a student at the University
        of Southern Maine studying Computer Science, slated to graduate in the
        spring 2024.
      </p>
      <p>
        Some of my favorite langauges/frameworks to use include:<br /> <span class="poppins text-blue-500">
        JavaScript, Svelte, React/React Native, Python, Elixir, Java, and C++.</span>
      </p>
  ...
  <section id="projects" class="py-20 lg:py-32 flex flex-col gap-24">
    <div class="flex flex-col gap-4 text-center">
      ...
      <h3 class="font-semibold text-3xl sm:text-4xl md:text-5xl">
        Check out some of my favorite <span class="poppins text-blue-500">projects</span>.
      </h3>
    </div>
    <a
